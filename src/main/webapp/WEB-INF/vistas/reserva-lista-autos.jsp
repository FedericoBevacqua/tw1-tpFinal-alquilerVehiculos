	...
	<div class="row">
		<div class="col-sm-4">
			<form action="reserva-lista-autos" method="POST">
				...
				<input type="checkbox" name="Toyota">Toyota<br> <br>
				Ordenar por :<br> <input type="checkbox" name="menorPrecio">Menor
				Precio<br> <input type="checkbox" name="mayorPrecio">Mayor
				Precio<br>
				<br>
				<div class="col-sm-6">
					...
					<br>
					<br>
					<button class="btn btn-lg btn-primary btn-block" type="submit">Borrar
						Filtros</button>
					<br>
				</div>
			</form>
